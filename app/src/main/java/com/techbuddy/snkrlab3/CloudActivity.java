    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CloudActivity.this, CameraActivity.class);
        ...
        arrowLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CloudActivity.this, AlphaActivity.class);
                startActivity(intent);
            }
        });
        ...
        arrowRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CloudActivity.this, NMDActivity.class);
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CloudActivity.this, AdidasActivity.class);
                startActivity(intent);
            }
        });
